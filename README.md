...
Atlas is a library implementing an attested TLS (aTLS) protocol. It delivers verified TLS connections to Trusted Execution Environments (TEEs) from different platforms (Python, Node.js, Browsers/Wasm, Rust).
...
### Key Features
- **Multi-platform**: Python (PyO3), Node.js (NAPI-RS), WASM for browsers, and a Rust crate (native)
...
- **Python**: `pip install atlas-python` → [See python/README.md](python/README.md)
...
- **[python/README.md](python/README.md)** - Python binding API reference and examples
...
- [python/](python/) - Python bindings via PyO3/Maturin
...
For platform-specific build instructions, see [python/README.md](python/README.md), [node/README.md](node/README.md), and [wasm/README.md](wasm/README.md).
