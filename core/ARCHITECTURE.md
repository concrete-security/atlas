...
This document describes the architecture of the `atlas-rs` crate, designed for contributors who want to understand the design or extend it with new TEE verifiers.
